...
SingleTapSensor::SingleTapSensor(int32_t sensorHandle, ISensorsEventCallback* callback)
    ...
    mSensorInfo.typeAsString = "com.moto.sensor.tap_gesture";
    ...
    mPollFd = open("/sys/devices/platform/soc/a80000.spi/spi_master/spi2/spi2.0/tap_gesture_pressed", O_RDONLY);
    if (mPollFd < 0) {
